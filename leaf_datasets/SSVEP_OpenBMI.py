"""
Preprocess the OpenBMI EEG dataset for four-class SSVEP frequency decoding.
...
NAME = 'SSVEP_OpenBMI'
TEXT_LABELS = ['SSVEP/12.0hz', 'SSVEP/8.6hz', 'SSVEP/6.6hz', 'SSVEP/5.4hz']
CH_NAMES = [
...
if __name__ == '__main__':
    with mp.Pool(len(SUBJECTS)) as pool:
        res = pool.map(partial(proc_one, task='SSVEP'), SUBJECTS)
